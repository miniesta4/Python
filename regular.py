# -*- coding: utf-8 -*-
"""
Created on Sat Jan 28 18:14:38 2017
...
def match_star(p, pattern, text):
    ...
    return (match(pattern, text) or (match1(p, text)
            and match_star(p, pattern, text[1:]))) 
            
def test():
    assert search('baa*!', 'Sheep said baaaa!') == True
    assert search('baa*!', 'Sheep said baaaa humbug') == False
    assert match('baa*!', 'Sheep said baaaa humbug') == False
    assert match('baa*!', 'baaaa! said the sheep') == True
    print('Test passed.')
